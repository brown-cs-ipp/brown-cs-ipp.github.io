        ...
        <div className="navbar-links-container">
          <ThemeProvider theme={theme2}>
            <NavLink className="navbar-links"
              ...
              >
                <Typography><b>EVENTS</b></Typography></NavLink>
            <NavLink className="navbar-links"
              to="/partners"
              style={({ isActive }) => ({
                color: isActive ? '#193AA5' : '#000000',
            ...
            >
              <Typography><b>PARTNERS</b></Typography></NavLink>
            <NavLink className="navbar-links"
              to="/apply"
              style={({ isActive }) => ({
                color: isActive ? '#193AA5' : '#000000',
            ...
            >
                <Typography><b>APPLY</b></Typography></NavLink>
                <NavLink className="navbar-links"
              to="/resources"
              style={({ isActive }) => ({
                color: isActive ? '#193AA5' : '#000000',
            ...
            >
                <Typography><b>RESOURCES</b></Typography></NavLink>
          </ThemeProvider>
        </div>
      </div>
    );
  ...
  function buildMobileNavBarLinks() {
    return (
      <div className="mobile-menu">
        ...
        <ThemeProvider theme={theme2}>
        <div className="navbar-links-row" id={isNavExpanded ? "menu-visible" : "menu-hidden"}>
          <div className="navbar-links-mobile">
            <NavLink to="/events"
              ...
              <Typography><b>EVENTS</b></Typography>
            </NavLink>
          </div>
          <div className="navbar-links-mobile">
            <NavLink className="navbar-links-mobile"
              onClick={toggleMobileMenu}
              to="/partners"
              style={({ isActive }) => ({
                color: isActive ? '#193AA5' : '#000000',
              ...
              <Typography><b>PARTNERS</b></Typography>
            </NavLink>
          </div>
          <div className="navbar-links-mobile">
            <NavLink className="navbar-links-mobile"
              ...
              <Typography><b>APPLY</b></Typography>
            </NavLink>
          </div>
          <div className="navbar-links-mobile">
            <NavLink className="navbar-links-mobile"
              ...
              <Typography><b>RESOURCES</b></Typography>
            </NavLink>
          </div>
  ...
  return (
    <div className="navbar-container"> 
      <div className="navbar-logo">
        <a href={url}> <img className="brown" src={brownlogo} alt="brown university logo" onClick={handleClick}/> </a>
        <Divider orientation="vertical" flexItem /> 
        <Link to="/"> <img className="ipp" src={ipplogo} alt="ipp logo"/> </Link>
        <Link to="/">
          <ThemeProvider theme={theme}>
            <BrowserView><Typography>Industry Partners Program</Typography></BrowserView>
            <MobileView><Typography>IPP</Typography></MobileView>
          </ThemeProvider>
        </Link>
      </div>
